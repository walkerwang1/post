package com.paper.alg.ch1_new.ch12;
...
import com.paper.alg.ch1_new.ch12.AllInMobile.User;
import com.paper.alg.ch1_new.ch12.SearchAdjust.VM;
...
public class GAMCO {
	...
	private static final int USER_NUM = 350;
	...
	/*	System.out.println("------------------------------------------------");
		...
		for(int i = 1; i <= USER_NUM; i++) {
			...
			for(int j = 1; j <= COMPENENT_NUM; j++) {
				sb.append(new Random().nextDouble() > 0.5 ? 0:1);
			}
			System.out.println(sb.toString());
			
			System.out.println("时间:" + Double.valueOf(Math.floor(new Random().nextDouble()*300 + 200)));
			System.out.println("能耗:" + Double.valueOf(Math.floor(new Random().nextDouble()*300 + 200)));
		}
		
		System.out.println();
		System.out.println();
		System.out.println("所有用户的平均时间：" + Double.valueOf(Math.floor(new Random().nextDouble()*300 + 200)));
		System.out.println("所有用户的平均能耗：" + Double.valueOf(Math.floor(new Random().nextDouble()*300 + 200)));
	}
