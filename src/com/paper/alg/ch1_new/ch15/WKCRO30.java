...
public class WKCRO30 {

	private static final int USER_NUM = 700;
	private static final int VM_NUM = 30;
	...
	public void readInputFile() {
		try {
			for (int i = 1; i <= USER_NUM; i++) {
				...
				URL dir = WKCRO30.class.getResource(""); // file:/E:/workspace/post/bin/com/paper/alg/ch1/
				// 用户i的配置文件
