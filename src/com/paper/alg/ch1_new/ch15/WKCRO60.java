 ...
 */
public class WKCRO60 {

	private static final int USER_NUM = 1500;
	private static final int VM_NUM = 60;
	...
	public void readInputFile() {
		try {
			for (int i = 1; i <= USER_NUM; i++) {
				...
				URL dir = WKCRO60.class.getResource(""); // file:/E:/workspace/post/bin/com/paper/alg/ch1/
				// 用户i的配置文件
