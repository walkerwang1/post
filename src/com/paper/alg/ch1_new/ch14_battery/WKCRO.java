package com.paper.alg.ch1_new.ch14_battery;
...
public class WKCRO {
	...
	public void showResult() {
		...
		System.out.println("所有用户的平均时间：" + Double.valueOf(df.format(avgMakeSpan -100)));
...
//			printMolecule(molecule);
	...
	public double compPE(int i, Molecule molecule, double[] ET, double RT_min) {
		...
		//还要传入两个权重，电量充足0.
		double PE = 0.2 * (molecule.makespan - T_min) / (T_max - T_min) + 
				0.8 * (molecule.power - E_min) / (E_max - E_min);
