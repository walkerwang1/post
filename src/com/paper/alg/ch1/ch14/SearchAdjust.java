package com.paper.alg.ch1.ch14;
...
public class SearchAdjust {
	...
	private static final int USER_NUM = 15;
...
//			printMolecule(molecule);
	...
	public double compPE(int i, Molecule molecule, double[] ET, double RT_min) {
		...
		//还要传入两个权重
		double PE = 0.9 * (molecule.makespan - T_min) / (T_max - T_min) + 
				0.1 * (molecule.power - E_min) / (E_max - E_min);
